...
Let's read the data into R and save it to a variable called `surveys`. Type this into your script. Unlike when we typed in the console, hitting 'enter'/'return' won't execute the command; we've essentially just written it in a text file. So to execute it, we'll have to press the 'Run' button in the top right of the editor pane, or a shortcut is command-enter.
