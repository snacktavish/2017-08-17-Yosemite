...
***In Progress!!! - this is a lesson I've used previously that I'm going to update a bit***
...
- common git commands: [happy git with R - Jenny Bryan](http://happygitwithr.com/usage-git-cmds.html)